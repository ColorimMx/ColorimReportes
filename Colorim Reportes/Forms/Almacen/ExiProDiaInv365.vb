...
Public Class ExiProDiaInv365
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Colorim_Reportes.ExiProDiaInv365.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExiProDiaInv365
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExiProDiaInv365 = New ExiProDiaInv365()
        rpt.Site = Me.Site
        Return rpt
    End Function

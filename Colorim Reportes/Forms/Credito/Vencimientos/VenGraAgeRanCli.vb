...
Public Class VenGraAgeRanCli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Colorim_Reportes.VenGraAgeRanCli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVenGraAgeRanCli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VenGraAgeRanCli = New VenGraAgeRanCli()
        rpt.Site = Me.Site
        Return rpt
    End Function

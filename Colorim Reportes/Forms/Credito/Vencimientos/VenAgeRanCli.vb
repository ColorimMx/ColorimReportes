...
Public Class VenAgeRanCli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Colorim_Reportes.VenAgeRanCli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVenAgeRanCli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VenAgeRanCli = New VenAgeRanCli()
        rpt.Site = Me.Site
        Return rpt
    End Function

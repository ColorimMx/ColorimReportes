...
Public Class VenAgeCliRan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Colorim_Reportes.VenAgeCliRan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVenAgeCliRan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VenAgeCliRan = New VenAgeCliRan()
        rpt.Site = Me.Site
        Return rpt
    End Function

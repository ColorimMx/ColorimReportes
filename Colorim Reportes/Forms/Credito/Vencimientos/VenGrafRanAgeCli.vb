...
Public Class VenGrafRanAgeCli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Colorim_Reportes.VenGrafRanAgeCli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVenGrafRanAgeCli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VenGrafRanAgeCli = New VenGrafRanAgeCli()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class VenGrafAgeCliRan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Colorim_Reportes.VenGrafAgeCliRan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVenGrafAgeCliRan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VenGrafAgeCliRan = New VenGrafAgeCliRan()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class VenRanAgeCli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Colorim_Reportes.VenRanAgeCli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVenRanAgeCli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VenRanAgeCli = New VenRanAgeCli()
        rpt.Site = Me.Site
        Return rpt
    End Function
